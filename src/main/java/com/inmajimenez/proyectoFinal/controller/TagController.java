...
@RestController
@RequestMapping("/api")
@CrossOrigin(origins = "https://projectfrontinma-jg1b096qy-inmalmeda.vercel.app", methods= {RequestMethod.GET,RequestMethod.POST,RequestMethod.PUT,RequestMethod.DELETE})
